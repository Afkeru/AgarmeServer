...
namespace AgarmeServer.Client
{
    public abstract class IClient
    {
        ...
        public double Mass { set; get; }//所有细胞质量和
        public HKPoint DeathLoc { set; get; }//死亡坐标
        ...
        public bool CheckAlive() => OwnCells.Count is <= 0 || Mass is <1;
    }
}
