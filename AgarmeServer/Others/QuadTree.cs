...
namespace AgarmeServer.Others
{
    ...
    public class QuadTree<T> : ICollection<T> where T : IQuadStorable
    {
        ...
        /// Creates a QuadTree for the specified area.
        /// </summary>
        /// <param name="x">The top-left position of the area RectangleF.</param>
        /// <param name="y">The top-right position of the area RectangleF.</param>
        /// <param name="width">The width of the area RectangleF.</param>
        /// <param name="height">The height of the area RectangleF.</param>
        public QuadTree(int x, int y, int width, int height)
        {
            quadTreeRoot = new QuadTreeNode<T>(new RectangleF(x, y, width, height));
        }
        ...
        /// <summary>
        /// Get the objects in this tree that intersect with the specified RectangleF.
        /// </summary>
    ...
    public class QuadTreeNode<T> where T : IQuadStorable
    {
        ...
        private const int maxObjectsPerNode = 50;
        ...
        private RectangleF rect; // The area this QuadTree represents
        ...
        /// </summary>
        /// <param name="rect">The area this QuadTree object will encompass.</param>
        public QuadTreeNode(RectangleF rect)
        {
            this.rect = rect;
        }
        ...
        private void Subdivide()
        {
            ...
            childTL = new QuadTreeNode<T>(this, new RectangleF(rect.Left, rect.Top, size.X, size.Y));
            childTR = new QuadTreeNode<T>(this, new RectangleF(mid.X, rect.Top, size.X, size.Y));
            childBL = new QuadTreeNode<T>(this, new RectangleF(rect.Left, mid.Y, size.X, size.Y));
            childBR = new QuadTreeNode<T>(this, new RectangleF(mid.X, mid.Y, size.X, size.Y));
        ...
        {
            // If this quad doesn't contain the items RectangleF, do nothing, unless we are the root
        ...
        internal void GetObjects(RectangleF searchRect, ref List<T> results)
        {
            ...
            if (results != null)
            {
                ...
                else if (searchRect.IntersectsWith(this.rect))
                {
        ...
        internal void GetAllObjects(ref List<T> results)
        {
            ...
            if (objects != null)
            {
                ...
                for(int i=0;i< objects.Count;i++)
                {
                    QuadTreeObject<T> qto = objects[i];
