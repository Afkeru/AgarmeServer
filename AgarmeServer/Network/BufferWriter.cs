...
namespace AgarmeServer.Network
{
    ...
    public unsafe static class BufferWriter
    {
        ...
        public static T[] MergeTwoArray<T>(T[] buffer1, T[] buffer2, int offset = 0)
        {
        ...
        public static byte[] MergeBytes(this byte[] data1, byte[] data2)
        {
        ...
        public static byte[] WritePackage(byte header, byte[] src)
        {
            ...
            bytes[0] = header;
            BufferWriter.WriteBytesToBytes(bytes, src, 1);
            return bytes;
        }
            ...
            where T:unmanaged
        {
            ...
            bytes[0] = header;
            BufferWriter.WriteUnmanaged<T>(len,bytes,1);
            BufferWriter.WriteBytesToBytes(bytes, src, 1+ length);
            return bytes;
        }
    }
}
